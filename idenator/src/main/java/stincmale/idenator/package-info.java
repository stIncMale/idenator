 ...
 * <p>
 * It worth noting that the flavour of persistence of a generator can be achieved by using a random ID generator
 * (e.g. <a href="https://tools.ietf.org/html/rfc4122#section-4.1.3">UUID version 4</a> implemented by {@link java.util.UUID#randomUUID()})
 * and requiring identifiers to contain a large enough amount of data to make the probability of generating the same value insignificantly small.
 * So a persistent ID generator does not necessarily have to access a persistent storage but usually, it does.
 * <p>
