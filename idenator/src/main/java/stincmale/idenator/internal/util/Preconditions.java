...
import stincmale.idenator.doc.Nullable;
...
public final class Preconditions {
  ...
  public static final void checkArgument(
    ...
    if (!checkArgumentExpression) {
      throw new IllegalArgumentException(format("The argument %s is illegal. %s", safeParamName, safeParamRestrictionDescription));
    }
  }
