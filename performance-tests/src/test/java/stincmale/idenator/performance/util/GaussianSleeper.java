...
/**
 * A {@link Delayer} that puts a thread calling {@link #delay()} into {@link Thread.State#TIMED_WAITING} state
 * for a duration picked by a pseudorandom generator of Gaussian distributed (but capped) durations.
 */
@ThreadSafe
public final class GaussianSleeper implements Delayer {
