 ...
 */
@ThreadSafe
public final class StampedLockHiLoLongIdGenerator extends AbstractHiLoLongIdGenerator {
  private final StampedLock lock;
  private final AtomicLong lo;
  private long hi;

  public StampedLockHiLoLongIdGenerator(final HiValueGenerator hiValueGenerator, final long loUpperBoundOpen) {
